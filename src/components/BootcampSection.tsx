...
const BootcampSection = () => {
  const bootcamps = [{
    ...
    description: "Our highly-popular PSLE Power Up Bootcamp is designed to provide structured revision and intensive practice for PSLE success. With 40+ hours of lessons, 300+ pages of latest revision materials, and live Q&A walkthroughs, students gain a comprehensive understanding of PSLE topics, question trends and exam strategies. A motivational segment and parent briefings ensure both students and parents are well-prepared.",
    formats: [],
    objectives: ["40+ hours of lessons and 300+ pages of refreshed PSLE Power Up revision materials and practice papers", "Reinforce understanding of PSLE topics and concepts, gain familiarity with trending PSLE questions and common errors, and hone PSLE question analysis and answering techniques", "Bonus segments included: Live Q&A walkthroughs, parent briefings and student motivational segment"],
    ...
    formats: [],
    objectives: ["Practise with our latest PSLE Chinese Oral Bootcamp materials", "Gain familiarity with potential PSLE Chinese Oral topics and scenarios and reinforce effective oral exam techniques and frameworks", "Practice under exam-simulated conditions with 1-to-1 mock tests"],
    ...
    formats: [],
    objectives: ["Practise with our refreshed PSLE Last Lap materials", "Intensive revision on targeted problematic exam components and reinforce understanding and application of exam techniques", "Receive timely teaching support for the final sprint to PSLE"],
  ...
  return (
    <section className="pt-8 pb-16 md:pt-12 md:pb-24 px-4 bg-gradient-to-b from-pastel-blue/30 to-blue-50/30">
