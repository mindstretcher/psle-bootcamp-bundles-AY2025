...
const ObsessedSection = () => {
  const features = [{
    ...
    title: "Latest PSLE Bootcamp Materials",
    description: "Our PSLE Bootcamp materials are refreshed annually with new content and updated to align with the latest MOE syllabus. These materials are designed to help conquer weaknesses and prepare students well for the PSLE."
  }, {
  ...
  return (
    <section className="pt-8 pb-16 md:pt-12 md:pb-24 px-4 bg-gradient-to-b from-white/0 to-pastel-blue/30">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-slate-600 text-center mb-16 max-w-3xl mx-auto">
          What makes our bootcamps effective — proven PSLE strategies, updated
          materials, and experienced teachers to support every student for PSLE.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-slate-100 animate-fade-in-up"
              style={{
                animationDelay: `${index * 100}ms`,
              }}
            >
              <div className="flex flex-col items-center text-center">
                <div className="flex-shrink-0 flex items-center justify-center w-12 h-12 rounded-full bg-pastel-blue mb-4">
                  {feature.icon}
                </div>
                <h3 className="font-semibold text-xl mb-2 text-educational-dark font-display">
                  {feature.title}
                </h3>
